---
title: "2. Dasar Pemrograman Menggunakan R"
draft: false
date: '2019-03-09T00:00:00+07:00'
output: pdf_document
menu:
  tutorial:
    parent: PART 1 - Bahasa Pemrograman R
    weight: 2
linktitle: Dasar Pemrograman Menggunakan R
type: docs
---
...
> * [List](#2-11-list)
> * [Loop](#2-12-loop)
> * [Loop Menggunakan Apply Family Function](#2-13-loop-menggunakan-apply-family-function)
> * [Decision Making](#2-15-decision-making)
> * [Fungsi](#2-16-fungsi)
...
```{r loop, echo=FALSE, fig.cap='Diagram umum loop (sumber: Primartha, 2018).', tidy=FALSE, fig.width=5, fig.height=7, fig.align='center'}
library(knitr)
...
## 2.13 Loop Menggunakan Apply Family Function
...
## 2.14 Loop Menggunakan map function pada Library `purrr`
...
```{r ifstatement, echo=FALSE, fig.cap='Diagram if statement (sumber: Primartha, 2018).', tidy=FALSE, fig.width=5, fig.height=7, fig.align='center'}
library(knitr)
...
### 2.15.2 if else statement

Pola dari *if else statement* disajikan pada Figure \@ref(fig:ifelse)

```{r ifelse, echo=FALSE, fig.cap='Diagram if else statement (sumber: Primartha, 2018).', tidy=FALSE, fig.width=5, fig.height=7, fig.align='center'}
library(knitr)
...
### 2.15.3 switch statement

Pola dari *switch statement* disajikan pada Figure \@ref(fig:switch)

```{r switch, echo=FALSE, fig.cap='Diagram switch statement (sumber: Primartha, 2018).', tidy=FALSE, fig.width=5, fig.height=7, fig.align='center'}
library(knitr)
