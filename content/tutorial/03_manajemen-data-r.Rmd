...
> * [Eksport File](#3-2-eksport-file)
> * [Tibble Data Format](#3-3-tibble-data-format)
> * [Merapikan Data](#3-4-merapikan-data)
> * [Transformasi Data](#3-5-transformasi-data)
...
6. Mengelompokkan operasi kelima fungsi diatas masing-masing berdasarkan grup data (`group_by()`).
...
Jika ingin urutan yang digunakan adalah dari yang terbesar ke terkecil untuk kedua variabel tersebut jalankan command berikut:
