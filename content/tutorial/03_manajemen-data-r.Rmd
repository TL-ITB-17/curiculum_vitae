...
> ## Daftar Isi:
>
> * [Tidyverse](#3-1-tidyverse)
> * [Import File](#3-2-import-file)
> * [Import Beberapa File Dalam Beberapa Baris Kode](#3-3-import-beberapa-file-dalam-beberapa-baris-kode)
> * [Eksport File](#3-4-eksport-file)
> * [Tibble Data Format](#3-5-tibble-data-format)
> * [Merapikan Data](#3-6-merapikan-data)
> * [Transformasi Data](#3-7-transformasi-data)
...
### 3.2.2 Membaca File CSV dan TXT Menggunakan Library readr
...
## 3.3 Import Beberapa File Dalam Beberapa Baris Kode
...
### 3.4.2 Eksport Data Menjadi Format Excel
...
### 3.4.3 Eksport File Dalam Format SAS, SPSS, dan STATA
...
#### 3.7.4.1 Scope Varian dari Fungsi Select
...
#### 3.7.4.2 Fungsi Pull Untuk Mengambil Nilai Pada Kolom
...
#### 3.7.5.2 Kustomisasi Nama Kolom dan Nama Baris
...
### 3.7.7 Mengkombinasikan Beberapa Operasi Menggunakan Operator Pipe (%>%)
...
```{r distvsave, echo=FALSE, fig.cap='Jarak vs rata-rata delay', tidy=FALSE, fig.width=5, fig.height=7, fig.align='center'}
# Tanpa pipe operator
