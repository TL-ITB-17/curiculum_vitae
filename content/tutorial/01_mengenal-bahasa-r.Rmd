...
> * [Working Directory](#1-6-working-directory)
> * [Fasilitas Help](#1-7-fasilitas-help)
...
```{r jendela-RStudio,echo=FALSE, fig.cap='Jendela RStudio.', tidy=FALSE, fig.width=5, fig.height=7, fig.align='center'}
library(knitr)
...
```{r working, echo=FALSE, fig.cap='Mengubah working directory.', tidy=FALSE, fig.width=5, fig.height=7, fig.align='center'}
library(knitr)
...
```{r default, echo=FALSE, fig.cap='Merubah working directory melalui Global options.', tidy=FALSE, fig.width=5, fig.height=7, fig.align='center'}
library(knitr)
...
```{r meandoc,echo=FALSE, fig.cap='Jendela help dokumentasi fungsi mean().', tidy=FALSE, fig.align='center'}
library(knitr)
...
```{r generalhelp,echo=FALSE, fig.cap='Jendela general help dokumentasi fungsi mean().', tidy=FALSE, fig.align='center'}
library(knitr)
...
```{r helpsearch,echo=FALSE, fig.cap='Jendela help search dokumentasi fungsi mean().', tidy=FALSE, fig.align='center'}
library(knitr)
