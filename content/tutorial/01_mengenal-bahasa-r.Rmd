...
```{r Logo,echo=FALSE, fig.cap='Logo R.', tidy=FALSE, fig.width=5, fig.height=7}
library(knitr)
...
```{r jendela-R,echo=FALSE, fig.cap='Jendela R.', tidy=FALSE, fig.width=5, fig.height=7}
library(knitr)
...
```{r jendela-RStudio,echo=FALSE, fig.cap='Jendela RStudio.', tidy=FALSE, fig.width=5, fig.height=7}
library(knitr)
