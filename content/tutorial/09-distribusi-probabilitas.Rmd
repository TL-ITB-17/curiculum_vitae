---
title: "9. Distribusi Probabilitas"
draft: no
...
menu:
  tutorial:
    ...
    weight: 9
linktitle: Distribusi Probabilitas
type: docs
---
...
> **Daftar Isi**
>
> - [Properti Umum dari Distribusi Probabilitas](#9-1-properti-umum-dari-distribusi-probabilitas)
> - [Distribusi Binomial dan Multinomial](#9-2-distribusi-binomial-dan-multinomial)
> - [Distribusi Hipergeometris](#9-3-distribusi-hipergeometris)
> - [Distribusi Binomial Negatif dan Distribusi Geometris](#9-4-distribusi-binomial-negatif-dan-distribusi-geometris)
> - [Distribusi Poisson](#9-5-distribusi-poisson)
> - [Distribusi Uniform](#9-6-distribusi-uniform)
> - [Distribusi Normal](#9-7-distribusi-normal)
> - [Distribusi Gamma dan Eksponensial](#9-8-distribusi-gamma-dan-eksponensial)
> - [Distribusi Chi-Square, Student's t, dan Snedecor's F](#9-9-distribusi-chi-square-student-s-t-dan-snedecor-s-f)
> - [Distribusi Kontinu Lainnya](#9-10-distribusi-kontinu-lainnya)
...
### 9.2.1 Multinomial Eksperimen dan Distribusi Multinomial
...
```{r normvis7, echo=FALSE, fig.cap='Visualisasi distribusi konsentrasi ozon Kota New York a)density plot, b)boxplot, c)ecdf, d)qq-plot', tidy=FALSE, out.width='90%', fig.align='center', message=FALSE, warning=FALSE}
...
```{r gammavis, echo=FALSE, fig.cap='Visualisasi distribusi gamma dengan variasi alpha dengan beta 1 a) density plot, b)ecdf', tidy=FALSE, out.width='90%', fig.align='center', message=FALSE, warning=FALSE}
...
```{r csqvis, echo=FALSE, fig.cap='Visualisasi distribusi chi-square dengan variasi derajat kebebasan a) density plot, b)ecdf', tidy=FALSE, out.width='90%', fig.align='center', message=FALSE, warning=FALSE}
...
```{r dtvis, echo=FALSE, fig.cap='Visualisasi distribusi t dengan variasi derajat kebebasan a) density plot, b)ecdf', tidy=FALSE, out.width='90%', fig.align='center', message=FALSE, warning=FALSE}
...
```{r dFvis, echo=FALSE, fig.cap='Visualisasi distribusi F dengan variasi derajat kebebasan a) density plot, b)ecdf', tidy=FALSE, out.width='90%', fig.align='center', message=FALSE, warning=FALSE}
...
```{r dbeta, echo=FALSE, fig.cap='Visualisasi distribusi beta dengan variasi derajat kebebasan a) density plot, b)ecdf', tidy=FALSE, out.width='90%', fig.align='center', message=FALSE, warning=FALSE}
...
```{r dlognnormalvis, echo=FALSE, fig.cap='Visualisasi distribusi beta dengan variasi mean dan sd a) density plot, b)ecdf', tidy=FALSE, out.width='90%', fig.align='center', message=FALSE, warning=FALSE}
x <- seq(0,5, length=100)
...
```{r dcauchyvis, echo=FALSE, fig.cap='Visualisasi distribusi t dengan variasi m dan beta a) density plot, b)ecdf', tidy=FALSE, out.width='90%', fig.align='center', message=FALSE, warning=FALSE}
x <- seq(-7,7, length=100)
...
```{r dlogistikvis, echo=FALSE, fig.cap='Visualisasi distribusi logistik dengan variasi mean dan simpangan baku, a) density plot, b)ecdf', tidy=FALSE, out.width='90%', fig.align='center', message=FALSE, warning=FALSE}
x <- seq(-7,7, length=100)
...
```{r weibullvis, echo=FALSE, fig.cap='Visualisasi distribusi weibull dengan variasi alpha dengan beta 1 a) density plot, b)ecdf', tidy=FALSE, out.width='90%', fig.align='center', message=FALSE, warning=FALSE}
x <- seq(0,6, length=100)
