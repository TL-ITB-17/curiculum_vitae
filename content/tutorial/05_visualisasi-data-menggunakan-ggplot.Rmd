...
> **Daftar Isi**
>
> - [Scatterplot](#5-1-scatterplot)
> - [Box Plot dan Violin Plot](#5-2-box-plot-dan-violin-plot)
> - [Bar Plot](#5-3-bar-plot)
> - [Line Plot](#5-4-line-plot)
> - [Pie Chart](#5-5-pie-chart)
> - [Histogram dan Density Plot](#5-6-histogram-dan-density-plot)
> - [QQ Plot](#5-7-qq-plot)
> - [Dot Chart](#5-8-dot-chart)
> - [ECDF Plot](#5-9-ecdf-plot)
> - [Parameter Grafik](#5-10-parameter-grafik)
...
Jika dinginkan kita juga dapat menambahkan density plot pada histogram. Pada Gambar \@ref(fig:gghist) ditambahkan density plot sehingga dihasilkan output seperti Gambar \@ref(fig:ggdenshist).
