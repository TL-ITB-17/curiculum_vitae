---
title: "8. Penaksiran Secara Statistika"
draft: no
date: '2019-04-03T00:00:00+07:00'
output: pdf_document
menu:
  tutorial:
    parent: PART 4 - Statistika Inferensial
    weight: 8
linktitle: Penaksiran Secara Statistika
type: docs
---
...
> **Daftar Isi**
>
> - [Definisi Interval Estimasi](#8-1-definisi-interval-estimasi)
> - [Interpretasi Interval Estimasi](#8-2-interpretasi-interval-estimasi)
> - [Interval Kepercayaan Median](#8-3-interval-kepercayaan-median)
> - [Interval Kepercayaan Mean](#8-4-interval-kepercayaan-mean)
> - [Interval Prediksi Nonparametrik](#8-5-interval-prediksi-nonparametrik)
> - [Transformasi DataInterval Prediksi Parametrik](#8-6-interval-prediksi-parametrik)
> - [Interval Kepercayaan Persentil (Interval Toleransi)](#8-7-interval-kepercayaan-persentil)
> - [Interval Kepercayaan Menggunakan Metode Bootstrap](#8-8-interval-kepercayaan-menggunakan-metode-bootstrap)
> - [Kegunaan Lain Dari Interval Kepercayaan](#8-9-kegunaan-lain-dari-interval-kepercayaan)
...
## 8.1 Definisi Interval Estimasi
...
## 8.2 Interpretasi Interval Estimasi
...
```{r iievis, echo=FALSE, fig.cap='Sepuluh interval kepercayaan 90 persen data dengan nilai mean sebenarnya 10 (Helsel dan Hirsch, 2002)', tidy=FALSE, out.width='80%', fig.align='center'}
library(knitr)
...
```{r iiedata, echo=FALSE, fig.cap='Histogram data dengan nilai mean populasi 1 dan simpangan baku populasi 0.75 (Helsel dan Hirsch, 2002)', tidy=FALSE, out.width='80%', fig.align='center'}
library(knitr)
...
```{r iievis2, echo=FALSE, fig.cap='Sepuluh interval kepercayaan 90 persen data dengan nilai mean sebenarnya  (Helsel dan Hirsch, 2002)', tidy=FALSE, out.width='80%', fig.align='center'}
library(knitr)
img1_path <- "/iievis2.png"
include_graphics(img1_path)
```

## 8.3 Interval Kepercayaan Median
...
### 8.3.1 Interval Estimasi Median Metode Nonparametrik
...
```{r iemednp, echo=FALSE, fig.cap='Probabilitas median populasi P50 pada dua sisi interval estimasi (Helsel dan Hirsch, 2002)', tidy=FALSE, out.width='80%', fig.align='center'}
library(knitr)
...
### 8.3.2 Metode Parametrik Interval Estimasi Median
...
### 8.4.1 Interval Kepercayaan Mean Untuk Distribusi Yang Simetris
...
### 8.4.2 Interval Kepercayaan Mean Untuk Distribusi Yang Asimetris
...
## 8.5 Interval Prediksi Nonparametrik
...
### 8.5.1 Interval Prediksi Nonparametrik Dua Sisi
...
```{r ipnds, echo=FALSE, fig.cap='Prediksi interval dua sisi (Helsel dan Hirsch, 2002)', tidy=FALSE, out.width='80%', fig.align='center'}
library(knitr)
img1_path <- "/ipnds.png"
include_graphics(img1_path)
```
...
### 8.5.2 Interval Prediksi Nonparametrik Satu Sisi
...
```{r ipss, echo=FALSE, fig.cap='Prediksi interval satu sisi (Helsel dan Hirsch, 2002)', tidy=FALSE, out.width='80%', fig.align='center'}
library(knitr)
img1_path <- "/ipss.png"
include_graphics(img1_path)
```
...
## 8.6 Interval Prediksi Parametrik
...
### 8.6.1 Interval Prediksi Distribusi Simetris
...
### 8.6.2 Interval Prediksi Untuk Distribusi Data Yang Tidak Simetris
...
## 8.7 Interval Kepercayaan Persentil
...
### 8.7.1 Interval Kepercayaan Nonparametrik Persentil
...
### 8.7.2 Uji Nonparametrik Untuk Persentil
...
```{r unup1, echo=FALSE, fig.cap='Interval estimasi persentil Xp sebagai penguji apakah Xp=X0. A) X0 didalam interval estimasi sehingga Xp tidak berbeda secara signifikan dari X0, B) X0 berada diluar rentang estimasi sehingga Xp berbeda secara signifikan dari X0. (Helsel dan Hirsch, 2002)', tidy=FALSE, out.width='80%', fig.align='center'}
library(knitr)
img1_path <- "unup1.png"
include_graphics(img1_path)
```

```{r unup2, echo=FALSE, fig.cap='Interval estimasi persentil Xp sebagai penguji apakah Xp>X0. A) X0 didalam interval estimasi sehingga Xp tidak signifikan lebih besar dari X0, B) X0 berada diluar rentang estimasi sehingga Xp signifikan lebih besar dari X0. (Helsel dan Hirsch, 2002)', tidy=FALSE, out.width='80%', fig.align='center'}
library(knitr)
img1_path <- "unup2.png"
include_graphics(img1_path)
```

```{r unup3, echo=FALSE, fig.cap='Interval estimasi persentil Xp sebagai penguji apakah Xp>X0. A) X0 didalam interval estimasi sehingga Xp tidak signifikan lebih kecil dari X0, B) X0 berada diluar rentang estimasi sehingga Xp signifikan lebih kecil dari X0. (Helsel dan Hirsch, 2002)', tidy=FALSE, out.width='80%', fig.align='center'}
library(knitr)
img1_path <- "unup3.png"
include_graphics(img1_path)
```
...
### 8.7.3 Interval Kepercayaan Parametrik Untuk Persentil
...
### 8.7.4 Uji Parametrik Untuk Persentil
...
## 8.8 Interval Kepercayaan Menggunakan Metode Bootstrap
...
```{r boot1, echo=FALSE, fig.cap='Distribusi bootstrap median', tidy=FALSE, out.width='80%', fig.align='center'}
plot(median.boot)
```
...
```{r boot2, echo=FALSE, fig.cap='Distribusi bootstrap mean', tidy=FALSE, out.width='80%', fig.align='center'}
plot(mean.boot)
```
...
```{r boot3, echo=FALSE, fig.cap='Distribusi bootstrap persentil 90', tidy=FALSE, out.width='80%', fig.align='center'}
plot(p90.boot)
```
...
## 8.9 Kegunaan Lain Dari Interval Kepercayaan
...
### 8.9.1 Implikasi Non-Normalitas Pada Pendeteksian *Outlier*
...
### 8.9.2 Implikasi Non-Normalitas Pada Kontrol Kualitas
...
### 8.9.3  Non-Normalitas Terhadap Desain Sampling
