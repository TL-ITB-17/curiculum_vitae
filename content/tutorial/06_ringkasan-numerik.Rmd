---
title: "6. Ringkasan Data"
draft: no
date: '2019-04-03T00:00:00+07:00'
output: pdf_document
menu:
  tutorial:
    parent: Statistika Deskriptif
    weight: 6
linktitle: Ringkasan Data
type: docs
---
...
> **Daftar Isi**
>
> - [Ukuran Pemusatan Data](#6-1-ukuran-pemusatan-data)
> - [Ukuran Sebaran Data](#6-2-ukuran-sebaran-data)
> - [Ringkasan Data Menggunakan Fungsi summary dan stat.desc](#6-3-ringkasan-data-menggunakan-fungsi-summary-dan-stat.desc)
> - [Ukuran Kemencengan Data](#6-4-ukuran-kemencengan-data)
> - [Outlier](#g-5-outlier)
> - [Transformasi Data](#6-6-transformasi-data)
...
## 6.3 Ringkasan Data Menggunakan Fungsi summary dan stat.des
...
Ukuran kemencengan yang lebih resisten adalah *quartile skew coefficient8 ($qs$). Merupakan ukuran kemencengan didasarkan pada ketiga nilai kuartil data seperti yang ditunjukkan pada Persamaan \@ref(eq:qs) yang menyatakan perbedaan pada jarak kuartil atas dan bawah terhadap median dibagi dengan IQR.
